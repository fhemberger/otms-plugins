Connected Projects: View Template
=================================
...
This plugin restores OTMS' built in "View Template" dialog for shared content
classes in SmartTree's Content Class menu menu.
...
1. Copy ViewTemplate.xml to the RedDot CMS plug-in folder
   (/ASP/PlugIns).

2. Import the plugin in the ServerManager and activate it.

3. Enable plugin for your projects. This plugin is only useful in projects
   using shared content class folders from another project.
...
1.01 - Minor fixes:
       * Fixed a minor bug (Removed dialog from project structure, where it appeared twice)
	   * Added README.txt
